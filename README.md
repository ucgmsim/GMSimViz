...
The qcore library is installed with the following command requiring root priviledges in the repository root. **Before installing**, edit the qcore/config.json file so that GMT_DATA has the full path to the resources folder.
```shell
